...
import { searchVisas, getFeaturedVisas, getVisaCategories, getDestinationCountries, getVisaDetails, getVisaPricing, getRequiredDocuments } from "./tools/visas.js";
import { listApplications, checkApplicationStatus, submitApplication } from "./tools/applications.js";
import { createPayment, checkPaymentStatus, getUserProfile } from "./tools/payments.js";
const server = new Server({ name: "onchain-visa", version: "1.0.0" }, { capabilities: { tools: {} } });
